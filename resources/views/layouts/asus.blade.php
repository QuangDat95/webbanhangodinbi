				...
				<div class="aside">
					...
					<div class="product-widget">
						...
						<div class="product-body">
							...
							<h3 class="product-name"><a href="{{route('properties',Encrypt($sellest->product->id))}}">{{$sellest->product->name}}</a></h3>
			...
			<div id="store" class="col-md-9">
				...
				<div class="row" id="option_change">
					...
					<div class="col-md-4 col-xs-6">
						<div class="product">
							<a href="{{route('properties',Encrypt($product->id))}}">
								<div class="product-img">
							...
							<div class="product-body">
								...
								<h3 class="product-name" style="height:30px"><a href="{{route('properties',Encrypt($product->id))}}">{{$product->name}}</a></h3>
