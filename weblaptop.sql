...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th2 24, 2022 lúc 01:59 AM
...
--
-- Cấu trúc bảng cho bảng `listorders`
--
...
--
-- Đang đổ dữ liệu cho bảng `listorders`
--

INSERT INTO `listorders` (`id`, `order_id`, `product_id`, `amount`, `created_at`, `updated_at`) VALUES
(1, '2', '5', '6', NULL, '2022-02-21 23:03:22');
...
INSERT INTO `orders` (`id`, `name`, `buy_date`, `phone`, `address`, `created_at`, `updated_at`) VALUES
(2, 'Nguyễn Quang Thành', '2022-02-17', '211313215', 'Hòa Khánh - Liên Chiểu - Đà Nẵng', NULL, '2022-02-21 23:53:00');
...
(1, 'Nguyễn Quang Đạt', 'quangdat@gmail.com', NULL, '$2y$10$HVFbA8zXBAIVurPfihRrDehgoLcqxeI9jRtIWdtoi0oHKH4fDliM6', NULL, NULL, NULL);
...
--
-- AUTO_INCREMENT cho bảng `listorders`
--
ALTER TABLE `listorders`
